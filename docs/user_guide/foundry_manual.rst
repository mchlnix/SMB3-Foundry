.. This page is mechanically converted from manual/foundry/foundry-manual.md.
.. Keep user-facing behavior changes synchronized with the source manual.
...
.. image:: ../../manual/foundry/level-selector.png
...
.. image:: ../../manual/foundry/overview_upper_left.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/overview_upper_right.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/overview_bottom_right.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/jump-editor.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/editor-settings.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/level-header-1.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/level-header-2.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/level-header-3.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/level-header-4.png
   :alt: Manual screenshot
   :class: manual-screenshot
...
.. image:: ../../manual/foundry/level-settings.png
   :alt: Manual screenshot
   :class: manual-screenshot
