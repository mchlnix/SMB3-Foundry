...
print("1. Merge the current dev into master.")
print("2. Make an annotated tag with the version number.")
print(f"3. First line should be '{new_version} Some codename'")
print("4. Then an empty line and beneath that the change notes.")
