...
class DialogTileSquareAssemblyEditor(ChildWindow, AbstractActionObject):
    ...
    def _set_up_layout(self) -> None:
        ...
        self.zoom_out_action.triggered.connect(lambda *_: setattr(self, "zoom", min(1, self.zoom + 1)))
        ...
        self.zoom_in_action.triggered.connect(lambda *_: setattr(self, "zoom", max(10, self.zoom - 1)))
