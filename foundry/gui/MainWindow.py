...
class MainWindow(QMainWindow):
    def __init__(self, path_to_rom=""):
        ...
        self.file_menu.save_rom_as_action.find_warnings.attach_requirement(self.safe_to_change)
        self.file_menu.save_rom_as_action.can_change.attach_requirement(lambda: self.can_save_rom(True))
