...
JumpUpdate, EVT_JUMP_UPDATE = wx.lib.newevent.NewCommandEvent()
JumpAdded, EVT_JUMP_ADDED = wx.lib.newevent.NewCommandEvent()
JumpRemoved, EVT_JUMP_REMOVED = wx.lib.newevent.NewCommandEvent()
