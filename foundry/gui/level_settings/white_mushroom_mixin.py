...
class WhiteMushroomHouseMixin(SettingsMixin):
    def __init__(self, parent):
        ...
        self._mushroom_checkbox = QCheckBox(_("Spawn White Mushroom House on Overworld"), self)
        ...
        mushroom_group.layout().addLayout(label_and_widget(_("Coins required to spawn:"), self._coins_required_spinner))
    ...
    def closeEvent(self, event):
        ...
        # mushroom house removed
            ...
            make_macro(self.undo_stack, _("Disable White Mushroom House"), RemoveObject(self.level, old_mushroom_item))
        ...
        # mushroom house added
            ...
            make_macro(self.undo_stack, _("Enable White Mushroom House"), AddObject(self.level, new_mushroom_item))
