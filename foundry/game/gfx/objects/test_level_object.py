...
def test_object_rendering_8_1(object_index, qtbot):
    object_factory = LevelObjectFactory(UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET, 0, [], False)
...
@pytest.mark.parametrize(
    ...
    [
        (0x20, 0x00, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),  # 45 Degree Underground Hill - Down/Left
        (0x2F, 0x00, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),
        (0x60, 0x03, HILLY_OBJECT_SET, HILLY_GRAPHICS_SET),  # 30 Degree Hill - Down/Left
        (0x6F, 0x03, HILLY_OBJECT_SET, HILLY_GRAPHICS_SET),
        (0xA0, 0x03, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),  # 30 Degree Underwater Hill - Down/Left
        (0xAF, 0x03, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),
    ],
)
...
@pytest.mark.parametrize(
    "object_index, domain, object_set, graphic_set",
    [
        (0x50, 0x04, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),  # Hilly Wall
        (0x5F, 0x04, UNDERGROUND_OBJECT_SET, UNDERGROUND_GRAPHIC_SET),
    ],
)
