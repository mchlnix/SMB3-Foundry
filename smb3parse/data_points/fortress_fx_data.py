...
class FortressFXData(_PositionMixin, _IndexedMixin, DataPoint):
    ...
    def read_values(self):
        ...
        self.replacement_tile = self._rom.int(self.replacement_tile_address)
    ...
    def write_back(self):
        ...
        self._rom.write(self.replacement_tile_address, self.replacement_tile)
    ...
    def __eq__(self, other):
        ...
        if self.replacement_tile != other.replacement_tile:
            return False
